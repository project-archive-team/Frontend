...
export const NewProjectModal: React.FC<NewProjectModalProps> = ({
  ...
  const [role, setRole] = useState('백엔드 엔지니어');
  const [teamSize, setTeamSize] = useState('4인 팀');
  const [period, setPeriod] = useState('2026.01 ~ 2026.06');
  const [techStackInput, setTechStackInput] = useState('React, TypeScript, Express, PostgreSQL');
